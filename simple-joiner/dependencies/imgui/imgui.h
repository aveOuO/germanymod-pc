...
enum ImGuiInputTextFlags_
{
    ...
    // Extension
    ImGuiInputTextFlags_NoLabel             = 1 << 24,   // Disable displaying the label (e.g. for InputText() with no label, or when using a custom label). This is useful to avoid displaying a label when the text is already displayed by another widget.
